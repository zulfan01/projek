...
<body>
	<nav>
		...
		<h3 class="float-left tittle" id="judul">Apotek</h3>	
		<div id="switch-color">
			<h4>Dark Theme</h4>
	...
	<div id="side-menu" style="display:none">
		...
		<li>
			<button class="btn btn-side-mn" data-color="grey" onclick="dash('view/page/dashboard.php')"><i class="fa fa-home pointer mrten mlten"></i>Apotek</button>
		</li>
		<li>
